        ...
        >
          <div>
            ...
            <h2 style={{ margin: "10px 0 0", letterSpacing: "-.02em" }}>
              Policies, disclosures, and store info
            </h2>
            <p className="small" style={{ marginTop: 8, maxWidth: 760 }}>
              This page is intentionally structured (not empty): it keeps
              financing language consistent, reduces disputes, and makes the
              store feel more trustworthy.
            </p>
          </div>
        ...
        <div className="legal-grid">
          ...
          <div className="card card-pad legal-box">
            ...
            <p className="small" style={{ marginTop: 8, opacity: 0.9 }}>
              This disclosure is shown to keep financing messaging consistent.
              If this page does not advertise a specific payment amount (e.g.
              “$40/mo”), the representative example is not required here.
            </p>

            <div className="hr" />

            {/* Usamos SOLO el componente para evitar duplicar texto a mano */}
            <AffirmDisclosure showExample={false} />
            ...
            <ul className="small legal-list">
              <li>
                Financing language must appear on the same URLs where financing
                is promoted.
              </li>
              <li>
                Keeping disclosures consistent reduces compliance risk and
                customer confusion.
              </li>
              <li>
                Clear policies reduce chargebacks and “where is my order?”
                tickets.
              </li>
            </ul>
          </div>
          ...
          <div className="card card-pad legal-box">
            ...
            <p className="small" style={{ marginTop: 8 }}>
              Replace the bracket text with your real business details (address,
              phone, timeframe). This is a clean baseline.
            </p>
        ...
        <div>
          ...
          <div className="faq">
            <div className="faq-item">
              ...
              <div className="faq-a">
                Financing availability depends on eligibility and purchase
                details. If financing is shown on a product page, the disclosure
                applies on that same URL.
              </div>
            </div>
            ...
            <div className="faq-item">
              ...
              <div className="faq-a">
                After shipment, you’ll receive tracking by email. If you didn’t
                receive it, use the contact form with your order number.
              </div>
            </div>

            <div className="faq-item">
              <div className="faq-q">What if my order arrives damaged?</div>
              <div className="faq-a">
                Contact support within [48 hours] with photos. We’ll help with a
                replacement/return depending on the case.
              </div>
            </div>
          </div>
        </div>
          ...
          >
            <div>
              ...
              <div className="small" style={{ marginTop: 6 }}>
                Questions about models, availability, or financing. Send a
                message and we’ll reply fast.
              </div>
            </div>
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              <Link className="btn" to="/catalog">
