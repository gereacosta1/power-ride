...
const solarProducts = [
  ...
  },
  {
    ...
    specs: ["2400W output", "2048Wh LiFePO4", "Solar charging supported"],
    badge: "Popular",
    inStock: true,
    type: "single",
    includes: [],
  ...
  {
    id: "s11",
    name: "Kit Solar 6kW Medium Residencial",
    category: "solar",
    price: 0,
    image: "/img/kit-solar-6kw-medium-residencial.jpeg",
    short:
      "Sistema solar completo para hogares y pequeños negocios, diseñado para energía confiable durante apagones y reducción del consumo eléctrico diario.",
    specs: [
      "Producción diaria estimada: 24-32 kWh",
      "Inversor híbrido 6200W TOP-SOLAR 48VDC",
      "Salida 110/220V split phase",
      "MPPT range 120-450VDC",
      "Capacidad PV 7200W",
      "Batería LiFePO4 51.2V 100Ah PowerMr",
      "Más de 4000 ciclos",
      "6 paneles solares monocristalinos 600-630W",
      "Cable solar negro 10 m",
      "Cable solar rojo 10 m",
      "Caja eléctrica AC/DC con protecciones",
    ],
    badge: "6kW Kit",
    inStock: true,
    type: "kit",
  ...
  {
    id: "s12",
    name: "SAKO Solar Kit 12kW with 16.3kWh Battery",
    category: "solar",
    price: 0,
    image: "/img/kit-solar-sako-12kw-16-3kwh.jpeg",
    short:
      "Complete SAKO solar kit with bifacial panels, split-phase inverter and lithium battery pack for residential or business energy backup.",
    specs: [
      "10 bifacial solar panels 620W",
      "12kW split-phase PV inverter",
      "16.3kWh lithium battery pack",
  ...
  {
    id: "s13",
    name: "Combo Energia Solar 10kW with 15kWh Battery",
    category: "solar",
    price: 0,
    image: "/img/combo-energia-solar-10kw-15kwh.jpeg",
    short:
      "Solar power system combo with inverter, battery and solar panels for reliable backup and energy support.",
    specs: [
      "10kW inverter",
      "15kWh battery",
      "8 solar panels 620W",
      "Solar power system bundle",
      "Mounting system included",
      "Designed for home or business backup",
    ],
    badge: "Combo",
    inStock: true,
    type: "kit",
